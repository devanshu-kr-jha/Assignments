...
def main():
    ...
    with (
        open("sentences.txt", "r") as fp,
        open("sentence_analysis.txt", "w") as output_file,
    ):
        for line in fp:
            palindrome = None
            words = line.split()  # ['Radar', 'is', 'a', 'palindrome']
            ...
            # print(f'Palindrome: {palindrome}', file=output_file)
